...
class Edrone():
	...
	def pid(self):
		...
		if(self.out_roll != 0.000):
			if(self.out_roll > 0)
			self.pwm_cmd.prop1 = 510.0 + self.out_roll
			self.pwm_cmd.prop2 = 510.0 - self.out_roll
			self.pwm_cmd.prop3 = 510.0 + self.out_roll
			self.pwm_cmd.prop4 = 510.0 - self.out_roll
