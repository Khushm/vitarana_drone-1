...
class Edrone():
    ...
    def __init__(self):
        rospy.init_node('position_controller1')  # initializing ros node with name drone_control
        ...
        self.Kp = [25.8, 250.8, 0]
#self.Kp = [56.8, 56.8, 0]
        self.Ki = [0, 0, 0]
        self.Kd = [28.1, 28.1, 0]
# self.Kd = [382.1, 382.1, 0]
        ...
        #self.z_error_pub = rospy.Publisher('/throttle_error', Float32, queue_size=1)
    ...
    def roll_set_pid(self, roll):
        ...
        self.Ki[0] = roll.Ki * 0.5
        self.Kd[0] = roll.Kd * 0.5

    def pitch_set_pid(self, pitch):
        self.Kp[1] = pitch.Kp * 0.1  # This is just for an example. You can change the ratio/fraction value accordingly
        self.Ki[1] = pitch.Ki * 0.1
...
# ----------------------------Define callback function like roll_set_pid to tune pitch, yaw--------------
    ...
    def pid(self):
        ...
        self.setpoint_euler[0] = 1500 * 0.02 - 30
        self.setpoint_euler[1] = 1500 * 0.02 - 30
        self.setpoint_euler[2] = 1500 * 0.02 - 30
	#print(self.setpoint_cmd)
        # Complete the equations for pitch and yaw axis
	#print(self.setpoint_euler[1])
